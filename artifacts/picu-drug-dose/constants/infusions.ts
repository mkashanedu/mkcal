...
export const INFUSION_DRUGS: InfusionDrug[] = [
...

  {
    ...
    vialConc_per_mL: 1,
    vialLabel: "1 mg/mL ampoule (Kinz 10 mg/10 mL) — also available as 2 mg/mL (Kinz 20 mg/10 mL)",
    diluent: "NS",
    standardConcentrations: [
      {
        label: "0.1 mg/mL — 5 mg (5 mL of 1 mg/mL) in 50 mL NS",
        totalDrug_mg: 5, totalVolume_mL: 50, concentration_per_mL: 0.1, unit: "mg",
      },
      {
        label: "0.2 mg/mL — 10 mg (10 mL of 1 mg/mL) in 50 mL NS",
        totalDrug_mg: 10, totalVolume_mL: 50, concentration_per_mL: 0.2, unit: "mg",
      },
      {
        label: "0.4 mg/mL — 20 mg (10 mL of 2 mg/mL) in 50 mL NS",
        totalDrug_mg: 20, totalVolume_mL: 50, concentration_per_mL: 0.4, unit: "mg",
      },
    ],
    notes: "Agonist-antagonist opioid. Vials: 1 mg/mL (10 mg/10 mL) or 2 mg/mL (20 mg/10 mL). Max 160 mcg/kg/hr. Less respiratory depression than morphine.",
