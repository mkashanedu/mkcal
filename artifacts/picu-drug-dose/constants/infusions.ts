...
export const INFUSION_DRUGS: InfusionDrug[] = [
...

  {
    ...
    vialConc_per_mL: 10,
    vialLabel: "10 mg/mL ampoule (Kinz/Nubain)",
    diluent: "NS",
    standardConcentrations: [
      {
    ...
    notes: "Agonist-antagonist opioid. Max dose 160 mcg/kg/hr. Less respiratory depression than morphine.",
  ...
  // ══════════════════════════════════════════════════════════════
  {
    ...
    vialConc_per_mL: 10,
    vialLabel: "10 mg/mL vial (25 mg/2.5 mL or 50 mg/5 mL)",
    diluent: "NS",
    standardConcentrations: [
      {
        label: "0.5 mg/mL — 25 mg in 50 mL NS",
...

  {
    ...
    vialConc_per_mL: 10,
    vialLabel: "10 mg/mL vial (50 mg/5 mL or 100 mg/10 mL)",
    diluent: "NS",
    standardConcentrations: [
      {
        label: "1 mg/mL — 50 mg in 50 mL NS",
...

  {
    ...
    vialConc_per_mL: 1,
    vialLabel: "1 mg/mL (reconstituted: 4 mg vial + 4 mL WFI)",
    diluent: "NS",
    standardConcentrations: [
      {
        label: "0.1 mg/mL — 5 mg in 50 mL NS",
        totalDrug_mg: 5, totalVolume_mL: 50, concentration_per_mL: 0.1, unit: "mg",
      },
      {
        label: "0.2 mg/mL — 10 mg in 50 mL NS",
